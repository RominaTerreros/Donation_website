    ...
    <header class="header">
        ...
        <nav class="nav">
            <ul class="navbar-links">
                ...
                <li>
                    <a href="Index/indexproductos.php">Productos</a>
                </li>

                <li>
                    <a href="Index/campanasIndex.php">Campañas</a>
                </li>

                <li>
                    <a href="#">Donaciones</a>
                    <ul>
                        <li><a href="Index/indexdonacion1.php">Donacion de Ropa</a></li>
                        <li><a href="Index/indexdonacion2.php">Donacion de Muebles</a></li>
                        <li><a href="Index/indexdonacion3.php">Donacion de Medicamentos</a></li>
                        <li><a href="donacionM.php">Donacion Monetaria</a></li>
                    </ul>
                </li>

                <li>
                    <a href="Index/indexPreguntasFrecuentes.php">Preguntas frecuentes</a>
                </li>

                <li>
                    <a href="Index/indexGaleria.php">Galería</a>
                </li>
            </ul>
        </nav>
        <button class="btn"><a href="login.php"><span><i class="fa-solid fa-right-to-bracket"></i> Iniciar
                    Sesión</span></a> </button>
        <button class="btn"><a href="sign_up.php"><span><i class="fa-solid fa-user-plus"></i></i> Registrarse</span></a>
        </button>
    </header>
